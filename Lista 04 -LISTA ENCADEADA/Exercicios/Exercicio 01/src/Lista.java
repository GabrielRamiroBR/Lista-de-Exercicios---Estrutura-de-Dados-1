public class Lista
{
	...
	/* Questão 01 - Lista 04: Complexidade O(n)
	...
	Melhorar complexidade criando um atributo para tamanho e acrescentando 1 toda vez que o método insere() é chamado
	e descrescendo 1 quando o meotod remove() é chamado
	 */
	/* nova complexidade O(1)*/
	public int tamanho(){
		return tam;
	}

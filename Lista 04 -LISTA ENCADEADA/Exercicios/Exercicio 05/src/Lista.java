public class Lista
{
	...
	protected class Elo
	{
		...
		public Elo(char elem)
		{
			dado = elem;
			prox = null;
		}
		
		public Elo(char elem, Elo proxElem)
		{
			dado = elem;
			prox = proxElem;
		}
	...
	public boolean buscaRecursiva(char elem)
	{
		if(this.vazia())
			return false;
	...
	private boolean buscaRecursiva(char elem, Elo p)
	{
		if(p == null)
			return false;
	...
	public boolean remove(char elem)
	{
		Elo p;

...
public class Arvbin<T extends Comparable<T>>
{
	...
	public boolean eSimetrica() {
		...
		return eSimetrica(esq, dir);
	}

	private boolean eSimetrica(Arvbin esq, Arvbin dir){
		if (esq == null && dir == null)
			return true;

		return ((esq != null && dir != null) && (eSimetrica(esq.esq, dir.dir) && (eSimetrica(esq.dir, dir.esq))));
	}

/*Exercicio 01
* Todos os métodos são O(n) sendo n a quantidade de nós da árvore,
*  pq eles percorrem necessariamente todos os nós da árvore*/

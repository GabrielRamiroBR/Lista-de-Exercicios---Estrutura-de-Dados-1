public class HeapBinariaMaxima
{
	...
	//Exercício 05 - no pior dos casos o loop é chamado n/2 vezes,
	// logo a complexidade do método tem limite superior assintotico O(n)
	public boolean verificaPropriedadeHeap(int[] vetor){
		n = vetor.length - 1; //desconsiderando a posiçao 0
